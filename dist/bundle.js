(function () {
    ...
    let JSONPath = Object.create(null);
    ...
    let TextProcess = Object.create(null);
    ...
    */
    ...
    function processData() {
    	if (!PROCESSED_DATA) {
    		...
    		const data$1 = data.supplemental.languageMatching["written-new"].slice(5);
    		const matches = data$1.map((d) => {
